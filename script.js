...
const scenes = [
  ...
  ["🎃","A pumpkin monster slips into marshmallows."],
  ["🚜","A monster truck drives over spaghetti."]
];
...
function pressButton(){
  ...
  setTimeout(()=>{
    ...
    question.textContent="🔊 Tap here to hear the question.";
